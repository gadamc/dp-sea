...
cloudantdata = sqlContext.read.format("com.cloudant.spark").option("cloudant.host",hostname).option("cloudant.username", username).option("cloudant.password",password).load(databaseName).cache()
